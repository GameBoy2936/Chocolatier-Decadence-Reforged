...
-- Refreshes the label displaying the currently tracked primary quest
...
-- Wrapper functions to launch the specific developer sub-menus
...
function devMenu()
	if CheckConfig("dev") then
		return BSGWindow { 
			...
			Button { x = 360, y = 0, w = 40, h = h, label = "#Ports", command = function() devPorts(0, h) end },

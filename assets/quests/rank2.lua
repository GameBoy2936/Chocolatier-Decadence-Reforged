...
CreateQuest
{
	...
	onaccept = { AwardText("rank2_08_extra01", nil, {label = "understood"}), AwardUnlockIngredient("raspberry"), AwardUnlockCharacter("tan_portkeep")},
...
CreateQuest
{
	...
	accept = "certainly",
	defer = "letmethinkaboutit",
	reject = "notworthmytime",
...
CreateQuest
{
	name = "tedd_welcome",
	starter = "main_tedd",
	accept = "open_reyk_offer_label",
	accept_length = "long",
	defer = "none",
	reject = "none",
	onaccept = {AwardText("tedd_welcome_extra01", nil, {label = "tedd_welcome_extra01_label", length = "extralong"}), AwardDelayQuest("ugr_01", 1), AwardDelayQuest("rank2_coffee01_prompt", 6), AwardDelayQuest("rank2_coffee01", 6), AwardUnlockCharacter("main_tedd"), AwardDiscoverPreference("main_tedd", "like", "user")},
}
...
CreateQuest
{
	...
	defer = "none",
	reject = "none",
	onaccept = {AwardText("ugr_01_extra01", nil, {label = "rightaway", length = "long"}), AwardUnlockCharacter("announcer")},
...
CreateQuest
{
	...
	oncomplete = {AwardMoney(10000), AwardItem("c01", -20), AwardRecipe("c05"), AwardDialog("recipes"), IncrementVariable("coffee"), AwardDelayQuest("rank2_coffee13", 5), AwardDelayQuest("ugr_02", 7), AwardUnlockIngredient("oat")},
	oncomplete_medium = {AwardMoney(16000), AwardItem("c01", -35), AwardRecipe("c05"), AwardDialog("recipes"), IncrementVariable("coffee"), AwardDelayQuest("rank2_coffee13", 5), AwardDelayQuest("ugr_02", 7), AwardUnlockIngredient("oat")},
	oncomplete_hard = {AwardMoney(20000), AwardItem("c01", -50), AwardRecipe("c05"), AwardDialog("recipes"), IncrementVariable("coffee"), AwardDelayQuest("rank2_coffee13", 5), AwardDelayQuest("ugr_02", 7), AwardUnlockIngredient("oat")},
}
...
CreateQuest
{
	...
	onaccept = {AwardText("meta_feli_extra01", nil, {label = "youcancountonme", length = "long"}), AwardOfferQuest("rank2_coffee04")},
...
CreateQuest
{
	...
	oncomplete = {IncrementVariable("coffee"), AwardItem("c11", -15),  AwardItem("c08", -15), AwardUnlockIngredient("whiskey"), AwardUnlockIngredient("ice_cream"), AwardRecipe("c06"), AwardDialog("recipes"), AwardUnlockCharacter("hav_hotelkeep")},
	oncomplete_medium = {IncrementVariable("coffee"), AwardItem("c11", -25),  AwardItem("c08", -25), AwardUnlockIngredient("whiskey"), AwardUnlockIngredient("ice_cream"), AwardRecipe("c06"), AwardDialog("recipes"), AwardUnlockCharacter("hav_hotelkeep")},
	oncomplete_hard = {IncrementVariable("coffee"), AwardItem("c11", -40),  AwardItem("c08", -40), AwardUnlockIngredient("whiskey"), AwardUnlockIngredient("ice_cream"), AwardRecipe("c06"), AwardDialog("recipes"), AwardUnlockCharacter("hav_hotelkeep")},
...
CreateQuest
{
	...
	goals = {RequireItem("b01", 150), RequireItem("b12", 150), HintPerson("ulu_hutkeep", "ulu_hut", "uluru")},
	goals_medium = {RequireItem("b01", 300), RequireItem("b12", 300), HintPerson("ulu_hutkeep", "ulu_hut", "uluru")},
	goals_hard = {RequireItem("b01", 400), RequireItem("b12", 400), RequireItem("i07", 200), HintPerson("ulu_hutkeep", "ulu_hut", "uluru")},
	oncomplete = {AwardItem("b01", -150), AwardItem("b12", -150), AwardItem("cacao", 5000), AwardHappiness("ulu_hutkeep", 100), IncrementVariable("coffee")},
	oncomplete_medium = {AwardItem("b01", -300), AwardItem("b12", -300), AwardItem("cacao", 7500), AwardHappiness("ulu_hutkeep", 100), IncrementVariable("coffee")},
	oncomplete_hard = {AwardItem("b01", -400), AwardItem("b12", -400), AwardItem("i07", -200), AwardItem("cacao", 10000), AwardHappiness("ulu_hutkeep", 100), IncrementVariable("coffee")},
}
...
CreateQuest
{
	...
	starter = "announcer",
	ender = "main_alex",
	accept = "illheadthereimmediately",
	accept_length = "long",
	defer = "none",
	reject = "none",
...
CreateQuest
{
	...
	reject = "none",
	autoComplete = true,
	onaccept = {AwardCustomSlot(), AwardDialog("recipes"), AwardDelayQuest("ugr_prompt", 15), AwardUnlockIngredient("cranberry")},
...
CreateQuest
{
	...
	onaccept = {AwardText("open_bali_extra01", nil, {label = "open_bali_extra01_label", length = "long"}), AwardUnlockPort("bali"), AwardUnlockIngredient("jasmine"), AwardRemoveCharacter("main_alex", "hav_hotel"), AwardPlaceCharacter("evil_tyso","_travelers"), AwardPlaceCharacter("evil_kath","_travelers"), AwardPlaceCharacter("evil_wolf","_travelers")},
}
...
CreateQuest
{
	...
	oncomplete = {AwardUnlockIngredient("apricot"), AwardItem("i01", -32), AwardMoney(20000), AwardUnlockCharacter("evil_bian")},
...
CreateQuest
{
	...
	onaccept = {AwardUnlockPort("sanfrancisco"), AwardUnlockIngredient("raisin"), AwardUnlockIngredient("marshmallow")},
...
CreateQuest
{
	...
	defer_length = "long",
	reject = "none",
	onaccept = {AwardText("rank2_30_extra01", nil, {label = "goodtoknow"}), AwardUnlockIngredient("cherry"), AwardUnlockIngredient("blueberry"), AwardUnlockIngredient("plum")},
...
CreateQuest
{
	...
	reject = "none",
	priority = 99,
	onaccept = {AwardText("rank2_33_extra01"), AwardItem("cayenne", 100), AwardItem("anise", 100), AwardRecipe("i04"), AwardDialog("recipes"), AwardRemoveCharacter("trav_02","_travelers"), AwardPlaceCharacter("trav_02","dou_emptybuilding1"), AwardDisableOrderForChar("trav_02")},
...
CreateQuest
{
	...
	oncomplete = {AwardItem("i07", -45), AwardRecipe("i10"), AwardDialog("recipes"), AwardUnlockIngredient("chamomile"), AwardUnlockIngredient("macadamia"), AwardUnlockCharacter("bog_churchkeep"), AwardUnlockCharacter("bog_plantationkeep")},
	oncomplete_medium = {AwardItem("i07", -60), AwardRecipe("i10"), AwardDialog("recipes"), AwardUnlockIngredient("chamomile"), AwardUnlockIngredient("macadamia"), AwardUnlockCharacter("bog_churchkeep"), AwardUnlockCharacter("bog_plantationkeep")},
	oncomplete_hard = {AwardItem("i07", -75), AwardRecipe("i10"), AwardDialog("recipes"), AwardUnlockIngredient("chamomile"), AwardUnlockIngredient("macadamia"), AwardUnlockCharacter("bog_churchkeep"), AwardUnlockCharacter("bog_plantationkeep")},
...
CreateQuest
{
	...
	oncomplete = {AwardDelayQuest("rank2_coffee16", 2), AwardItem("i09", -40), AwardRecipe("i12"), AwardDialog("recipes"), AwardUnlockIngredient("rosemary")},
	oncomplete_medium = {AwardDelayQuest("rank2_coffee16", 2), AwardItem("i09", -60), AwardRecipe("i12"), AwardDialog("recipes"), AwardUnlockIngredient("rosemary")},
	oncomplete_hard = {AwardDelayQuest("rank2_coffee16", 2), AwardItem("i09", -80), AwardRecipe("i12"), AwardDialog("recipes"), AwardUnlockIngredient("rosemary")},
...
CreateQuest
{
	...
	defer = "none",
	reject = "none",
	onaccept = {AwardBuildingOwned("san_factory"), AwardFactoryPowerup("san_factory", "truffle", "recycler"), AwardUnlockIngredient("powder"), AwardUnlockIngredient("currant"), AwardUnlockIngredient("honey"), AwardUnlockIngredient("cayenne"), AwardUnlockIngredient("lemon"), AwardUnlockIngredient("raspberry"), AwardUnlockIngredient("cashew"), AwardUnlockIngredient("wasabi"), AwardRecipe("t01"), AwardDialog("recipes"), AwardText("rank2_50_extra01")},
...
CreateQuest
{
	...
	oncomplete = {AwardItem("t02", -1), AwardRecipe("t10"), AwardDialog("recipes"), IncrementVariable("metatruf"), AwardDelayQuest("rank2_51_done_hint", 6), AwardUnlockCharacter("tor_marketkeep")},
	oncomplete_medium = {AwardItem("t02", -10), AwardRecipe("t10"), AwardDialog("recipes"), IncrementVariable("metatruf"), AwardDelayQuest("rank2_51_done_hint", 6), AwardUnlockCharacter("tor_marketkeep")},
	oncomplete_hard = {AwardItem("t02", -50), AwardRecipe("t10"), AwardDialog("recipes"), IncrementVariable("metatruf"), AwardDelayQuest("rank2_51_done_hint", 6), AwardUnlockCharacter("tor_marketkeep")},
...
CreateQuest
{
	...
	defer_length = "long",
	reject = "none",
	onaccept = {AwardText("hav_shop_01_extra01"), AwardUnlockIngredient("guava")},
...
CreateQuest
{
	...
	onaccept_medium = {AwardItem("b03",- 25), AwardMoney(15000), AwardUnlockCharacter("trav_06"), AwardDiscoverPreference("trav_06", "like", "caramel")},
	onaccept_hard = {AwardItem("b03",- 25), AwardMoney(20000), AwardUnlockCharacter("trav_06"), AwardDiscoverPreference("trav_06", "like", "caramel")},
...
CreateQuest
{
	name = "rank2_story_cap_shopkeep_1",
	starter = "cap_shopkeep",
	accept = "ok",
	accept_length = "long",
	defer = "none",
	reject = "none",
	require = {RequireQuestComplete("rank2_06"), RequireRecipesMade(6, "bar")},
	priority = 1,
	visible = false,
	autoComplete = true,
}
...
CreateQuest
{
	name = "rank2_story_cap_marketkeep_1",
	starter = "cap_marketkeep",
	accept = "ok",
	accept_length = "long",
	defer = "none",
	reject = "none",
	require = {RequireQuestComplete("rank2_coffee03"), RequireRecipesMade(2, "beverage")},
	priority = 1,
	visible = false,
	autoComplete = true,
}
...
CreateQuest
{
	name = "rank2_story_rey_shopkeep_1",
	starter = "rey_shopkeep",
	accept = "ok",
	accept_length = "long",
	defer = "none",
	reject = "none",
	require = {RequireRecipesKnown(2, "user")},
	priority = 1,
	visible = false,
	autoComplete = true,
}
...
CreateQuest
{
	name = "rank2_story_main_chas_1",
	starter = "main_chas",
	accept = "ok",
	accept_length = "long",
	defer = "none",
	reject = "none",
	require = {RequireQuestComplete("rank2_50"), RequireQuestIncomplete("rank2_51"), RequireRecipesMade(3, "truffle")},
	priority = 1,
	visible = false,
	autoComplete = true,
}
...
CreateQuest
{
	name = "rank2_story_main_deit_1",
	starter = "main_deit",
	accept = "ok",
	accept_length = "long",
	defer = "none",
	reject = "none",
	require = {RequireQuestComplete("rank2_33")},
	priority = 1,
	visible = false,
	autoComplete = true,
}
...
CreateQuest
{
	name = "rank2_story_san_barkeep_1",
	starter = "san_barkeep",
	accept = "ok",
	accept_length = "long",
	defer = "none",

...
CreateQuest
{
	...
	starter = "main_alex",
	ender = "main_feli",
	onaccept = {AwardRank(2), AwardText("tut_over_extra01"), AwardText("tut_over_extra03"), AwardText("tut_over_extra04"), AwardDelayQuest("tut_over_prompt", 500), AwardDelayQuest("rank2_12", 1), AwardDelayQuest("ugr_tease_00", 5), AwardUnlockPort("capetown"), AwardUnlockHistory("catalogue_history_letter_alex_sean_1")},
